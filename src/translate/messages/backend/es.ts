const messages = {
  ...
  NAME_ALREADY_REGISTERED:
    "Este nombre ya está siendo utilizado por otro usuario.",

  INVALID_EMAIL: "Introduzca un e-mail válido.",
  EMAIL_IS_REQUIRED: "Introduzca un e-mail.",
  EMAIL_ALREADY_REGISTERED:
    "Este email ya está siendo utilizado por otro usuario.",
  ...
  MIN_CARACHTERS_NUMBER: "El teléfono debe contener al menos 11 caracteres",
